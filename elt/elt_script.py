#1-this script firt check whether connection to source database is working.
#2-then next it defines source and destination configurations
#3-it copies the source dataase into an sql file and then loads this sql file to destination database
